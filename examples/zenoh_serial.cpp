/**
 * @file zenoh_serial.cpp   
 * @author Jan Schmidt
 * @brief 
 * @version 0.1
 * @date 2025-06-23
 * 
 * This example demonstrates how to use Zenoh-Pico with a serial connection.
 * It initializes a Zenoh session, declares a publisher, and publishes data periodically.
 * The Zenoh session is configured to use a serial connection with a specified baud rate.
 */
